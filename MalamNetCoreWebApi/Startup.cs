...
namespace MalamNetCoreWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //var srvv = services.First(p => p.GetType() is IDataAccessService);
            //var rrr = srvv?.Tasks;
        
            //     IDataAccessService service = services.Resolve<IDataAccessService>();

           
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo 
                            { Title = "MalamNetCoreWebApi", 
                                Version = "v1" ,
